...
naturalslopeslib.register_sloped_stomp = function(source_node_name, dest_node_name, stomp_desc)
	...
	if source_slopes == nil then
		core.log("warning", "[register_sloped_stomp] No slope registered for " .. source_node_name)
		return
	end
	if dest_slopes == nil then
		core.log("warning", "[register_sloped_stomp] No slope registered for " .. dest_node_name)
		return
	end
